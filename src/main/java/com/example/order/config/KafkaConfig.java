...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, CartCheckoutEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TYPE_MAPPINGS,
                "com.example.cart.events.CartCheckoutEvent:com.example.order.events.CartCheckoutEvent");

        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CartCheckoutEvent> kafkaListenerContainerFactory() {
